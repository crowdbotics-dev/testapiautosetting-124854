...
## Project Structure
    ...
    ├── testapiautosetting_124854  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124854`
...
2. Clone this repo and `cd testapiautosetting_124854`
